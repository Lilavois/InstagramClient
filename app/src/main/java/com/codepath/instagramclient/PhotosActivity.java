...
public class PhotosActivity extends Activity {
    ...
    public static final String CLIENT_ID = "089674cc4d0d4b7f9f356e94c614c3e1";
    ...
    public void fetchPopularPhotos(){
        ...
        client.get(url, null, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                // Autor Name: { "data" => [X] => "user" => "username"}
                JSONArray photosJSON = null;
                try {
                    photosJSON = response.getJSONArray("data");// array of posts
                    // interate array of posts
                    for (int i = 0; i < photosJSON.length(); i++) {
                        // get the json object at that position
                        JSONObject photoJSON = photosJSON.getJSONObject(i);
                        // decode the attibues of json int a data models
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable) {
                // DO SOMETHING
                // Interate each of the photo items and decode the into a java object
